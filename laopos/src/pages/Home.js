...
const Home = () => {
  ...
  const getShop = async (session) => {
    return await axios
      .post(
        "http://192.168.1.112:4000/api/getShop",
        {
          crossDomain: true,
          data: {
            session: session,
  ...
  const getSession = async (email, pass) => {
    return await axios
      .post("http://192.168.1.112:4000/api/getSession", {
        crossDomain: true,
        data: {
          email: email,
          pass: pass,
  ...
  const changeShop = async () => {
    ...
    return await axios
      .post(
        "http://192.168.1.112:4000/api/setShop",
        {
          crossDomain: true,
          data: {
            session: sess,
  ...
  const dispatch = async (odr, dboy, rowid) => {
    ...
    return await axios
      .post(
        "http://192.168.1.112:4000/api/sentOtp",
        {
          crossDomain: true,
          data: {
            session: sess,
  ...
  const dispatchOtp = async (otp) => {
    ...
    return await axios
      .post(
        "http://192.168.1.112:4000/api/submitOtp",
        {
          crossDomain: true,
          data: {
            session: sess,
  ...
  const getfreshOrders = async (session) => {
    return await axios
      .post(
        "http://192.168.1.112:4000/api/freshOrders",
        {
          crossDomain: true,
          data: {
            session: session,
  ...
  const getacceptedOrders = async (session) => {
    return await axios
      .post(
        "http://192.168.1.112:4000/api/acceptedOrders",
        {
          crossDomain: true,
          data: {
            session: session,
  ...
  const getreadyOrders = async (session) => {
    return await axios
      .post(
        "http://192.168.1.112:4000/api/readyOrders",
        {
          crossDomain: true,
          data: {
            session: session,
  ...
  const getdeliveredOrders = async (session) => {
    return await axios
      .post(
        "http://192.168.1.112:4000/api/deliveredOrders",
        {
          crossDomain: true,
          data: {
            session: session,
